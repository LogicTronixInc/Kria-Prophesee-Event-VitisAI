...
module histoframe_accel_AxiStream2MatStream_2_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [7:0] sub5_fu_94_p2;
reg   [7:0] sub5_reg_144;
wire   [4:0] sub44_fu_101_p2;
reg   [4:0] sub44_reg_149;
wire   [7:0] add_ln1033_fu_108_p2;
reg   [7:0] add_ln1033_reg_154;
...
histoframe_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
assign add_ln1033_fu_108_p2 = (last_blk_width_cast2_fu_82_p1 + 8'd127);
...
assign sub44_fu_101_p2 = ($signed(last_blk_width_cast5_fu_85_p1) + $signed(5'd31));

assign sub5_fu_94_p2 = ($signed(8'd128) - $signed(last_blk_width_cast2_fu_82_p1));

assign sub_fu_88_p2 = ($signed(cols_bound_per_npc_read_reg_115) + $signed(32'd4294967295));

endmodule //histoframe_accel_AxiStream2MatStream_2_s
