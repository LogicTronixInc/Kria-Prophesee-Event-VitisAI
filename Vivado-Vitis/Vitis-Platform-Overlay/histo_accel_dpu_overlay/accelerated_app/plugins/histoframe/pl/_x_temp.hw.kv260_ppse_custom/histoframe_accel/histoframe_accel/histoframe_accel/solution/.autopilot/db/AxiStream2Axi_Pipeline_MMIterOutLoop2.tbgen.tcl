...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "dat_out","offset": { "type": "dynamic","port_name": "dat_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln1332", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem2_WDATA sc_out sc_lv 128 signal 0 } 
	{ m_axi_gmem2_WSTRB sc_out sc_lv 16 signal 0 } 
	...
	{ m_axi_gmem2_RDATA sc_in sc_lv 128 signal 0 } 
	...
	{ sext_ln1332 sc_in sc_lv 60 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1332", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln1332", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "172803"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "172803"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln1332 { ap_none {  { sext_ln1332 in_data 0 60 } } }
