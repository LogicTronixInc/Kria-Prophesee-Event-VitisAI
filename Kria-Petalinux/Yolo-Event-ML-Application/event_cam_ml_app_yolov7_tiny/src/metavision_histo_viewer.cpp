...
//   std::cout<<"inside the runYolo"<<std::endl;
...
//   std::cout<<"height"<<height<<std::endl;
  ...
  for (int io = 0; io < 3; io++) {
    // std::cout<<"inside the loop"<<io<<std::endl;
...
//     // Print the result
//     std::cout << "Current time in milliseconds in preprocessing before resize is: "
//         << milliseconds_b << std::endl;

    resize(img, image2, Size(width, height), 0, 0, INTER_LINEAR);
    // resize(img,image_re,Size(rmax,bmax),0,0);
    // imwrite("resized_image.jpg",image2);
    // std::cout<<"pre prcessing"<<std::endl;
...
//     auto now_a = std::chrono::system_clock::now();

//     // Convert the current time to time since epoch
//     auto duration_a = now_a.time_since_epoch();
...
//     // Print the result
//     std::cout << "Current time in milliseconds in preprocessing after resize+scaling is: "
//         << milliseconds_a << std::endl;
    ...
    // std::cout<<"before post processing"<<std::endl;
