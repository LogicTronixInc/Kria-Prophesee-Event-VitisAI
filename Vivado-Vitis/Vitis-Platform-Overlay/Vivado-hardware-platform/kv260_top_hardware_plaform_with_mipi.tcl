...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_PORTS {5} $PL_PS_IRQ
  ...
  set_property -dict [list \
    CONFIG.Coe_File {/home/logictronix03/Downloads/kk/June9-2024-kv260-platform/kv260-ppse-hardware-platform/fpga-projects-0.2.2/projects/kv260/srcs/coe/kv260_system_register.coe} \
...
\
  ...
  # Create instance: zynq_processing_system_axi_periph, and set properties
  set zynq_processing_system_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 zynq_processing_system_axi_periph ]
  set_property CONFIG.NUM_MI {1} $zynq_processing_system_axi_periph
  ...
  connect_bd_intf_net -intf_net zynq_processing_system_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_processing_system/M_AXI_HPM0_LPD] [get_bd_intf_pins zynq_processing_system_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net zynq_processing_system_axi_periph_M00_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins zynq_processing_system_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_intc_0_irq [get_bd_pins PL_PS_IRQ/In4] [get_bd_pins axi_intc_0/irq]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins zynq_processing_system/maxihpm0_lpd_aclk] [get_bd_pins zynq_processing_system_axi_periph/ACLK] [get_bd_pins zynq_processing_system_axi_periph/M00_ACLK] [get_bd_pins zynq_processing_system_axi_periph/S00_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn] [get_bd_pins zynq_processing_system_axi_periph/ARESETN] [get_bd_pins zynq_processing_system_axi_periph/M00_ARESETN] [get_bd_pins zynq_processing_system_axi_periph/S00_ARESETN]
  ...
  connect_bd_net -net zynq_processing_system_pl_clk1 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins zynq_processing_system/pl_clk1]
  connect_bd_net -net zynq_processing_system_pl_resetn1 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in] [get_bd_pins zynq_processing_system/pl_resetn1]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_processing_system/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] -force
  ...
  set_property PFM_NAME {xilinx:kv260:kv260_ppse_hardware_platform:0.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.AXI_PORT {M_AXI_HPM1_FPD {memport "M_AXI_GP" sptag "" memory "" is_range "false"} S_AXI_HPC1_FPD {memport "S_AXI_HP" sptag "HPC1" memory "" is_range "false"} S_AXI_HP0_FPD {memport "S_AXI_HP" sptag "HP0" memory "" is_range "false"} S_AXI_HP1_FPD {memport "S_AXI_HP" sptag "HP1" memory "" is_range "false"} S_AXI_HP2_FPD {memport "S_AXI_HP" sptag "HP2" memory "" is_range "false"} S_AXI_HP3_FPD {memport "S_AXI_HP" sptag "HP3" memory "" is_range "false"}} [get_bd_cells /zynq_processing_system]
  set_property PFM.AXI_PORT {M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M02_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M03_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M04_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M05_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M06_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"} M07_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "false"}} [get_bd_cells /zynq_processing_system_axi_periph]
