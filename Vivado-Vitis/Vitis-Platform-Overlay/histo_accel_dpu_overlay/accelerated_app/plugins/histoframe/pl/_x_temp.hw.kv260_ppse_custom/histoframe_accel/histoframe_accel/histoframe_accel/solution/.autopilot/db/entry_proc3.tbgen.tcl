...
set Spec2ImplPortList { 
	...
	cols { ap_fifo {  { cols_dout fifo_port_we 0 32 }  { cols_num_data_valid fifo_status_num_data_valid 0 3 }  { cols_fifo_cap fifo_update 0 3 }  { cols_empty_n fifo_status 0 1 }  { cols_read fifo_data 1 1 } } }
