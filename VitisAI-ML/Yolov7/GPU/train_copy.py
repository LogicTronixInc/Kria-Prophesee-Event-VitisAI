...
def model():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/yolov72/weights/best.pt', help='model.pt path(s)')
...
def quantization(model, dataloader):
    parser = argparse.ArgumentParser()
    parser.add_argument(
        '--config_file',
        default=None,
    ...
    for i, (imgs, labels, paths, _) in enumerate(dataloader):
        ...
        out, train_out = quant_model(imgs)
        break
...
if __name__ == '__main__':
    ...
    if not opt.evolve:
        ...
        dataloader = train(hyp, opt, device, tb_writer)
