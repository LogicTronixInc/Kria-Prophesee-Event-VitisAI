...
class RepConv_OREPA(nn.Module):
    ...
    # def __init__(self, c1, c2, k=3, s=1, padding=1, dilation=1, groups=1, padding_mode='zeros', deploy=False, use_se=False, nonlinear=nn.Hardswish()):
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        coords = torch.stack(np.meshgrid([coords_h, coords_w]))
...
class SwinTransformerLayer(nn.Module):
    ...
    # def __init__(self, dim, num_heads, window_size=8, shift_size=0,
    #             mlp_ratio=4., qkv_bias=True, qk_scale=None, drop=0., attn_drop=0., drop_path=0.,
    #             act_layer=nn.Hardswish, norm_layer=nn.LayerNorm):
        super().__init__()
        self.dim = dim
        self.num_heads = num_heads
...
class SwinTransformerLayer_v2(nn.Module):
    ...
    # def __init__(self, dim, num_heads, window_size=7, shift_size=0,
    #         mlp_ratio=4., qkv_bias=True, drop=0., attn_drop=0., drop_path=0.,
    #         act_layer=nn.Hardswish, norm_layer=nn.LayerNorm, pretrained_window_size=0):
    #     super().__init__()
        self.dim = dim
