...
module histoframe_accel_AxiStream2Mat (
        ldata1_dout,
        ldata1_empty_n,
        ldata1_read,
        in_mat_data1_din,
...
histoframe_accel_entry_proc3 entry_proc3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
histoframe_accel_last_blk_pxl_width_1 last_blk_pxl_width_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
histoframe_accel_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
histoframe_accel_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
histoframe_accel_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
histoframe_accel_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (last_blk_pxl_width_1_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc3_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_1_U0_ap_ready & ap_sync_entry_proc3_U0_ap_ready);
...
endmodule //histoframe_accel_AxiStream2Mat
