...
entity histoframe_accel_AxiStream2MatStream_2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of histoframe_accel_AxiStream2MatStream_2_s is 
...
attribute shreg_extract : string;
    ...
    signal sub5_fu_94_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal sub5_reg_144 : STD_LOGIC_VECTOR (7 downto 0);
    signal sub44_fu_101_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal sub44_reg_149 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln1033_fu_108_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln1033_reg_154 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component histoframe_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component histoframe_accel_mul_32s_32s_32_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62 : component histoframe_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        bound => bound_reg_134,
        sext_ln1033 => sub44_reg_149,
        cols_bound_per_npc_load => cols_bound_per_npc_read_reg_115,
        sub => sub_reg_139,
        last_blk_width_load => last_blk_width_read_reg_127,
        sub5 => sub5_reg_144,
        add_ln1033 => add_ln1033_reg_154);

    mul_32s_32s_32_2_1_U37 : component histoframe_accel_mul_32s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                add_ln1033_reg_154 <= add_ln1033_fu_108_p2;
                bound_reg_134 <= grp_fu_77_p2;
                sub44_reg_149 <= sub44_fu_101_p2;
                sub5_reg_144 <= sub5_fu_94_p2;
    ...
    add_ln1033_fu_108_p2 <= std_logic_vector(unsigned(last_blk_width_cast2_fu_82_p1) + unsigned(ap_const_lv8_7F));
    ...
    in_mat_data1_write_assign_proc : process(grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62_in_mat_data1_write, ap_CS_fsm_state4)
    begin
    ...
    sub44_fu_101_p2 <= std_logic_vector(unsigned(last_blk_width_cast5_fu_85_p1) + unsigned(ap_const_lv5_1F));
    sub5_fu_94_p2 <= std_logic_vector(signed(ap_const_lv8_80) - signed(last_blk_width_cast2_fu_82_p1));
